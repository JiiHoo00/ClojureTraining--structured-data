...
(defn authors->string [authors]
  (clojure.string/join (interpose ", " (map author->string authors)))
)
...
(defn books->string [books]
  (let [book-amount (count books)]
    (cond
      ...
      (= book-amount 1) (str "1 book. " (book->string (get books 0)) ".")
      :else (str book-amount " books. " (clojure.string/join (interpose ". " (map book->string books))) ".")
    )
  )
)
